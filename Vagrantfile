...
Vagrant.configure("2") do |config|
  ...
  # запрещаем синкать дефолтные папки
  config.vm.synced_folder ".", "/vagrant", disabled: true
  # синкаем папку с проектом на хосте с папкой проекта на гесте. синкаем всю папку, чтобы попала data, из которой будем устанавливать скаченные файлы
